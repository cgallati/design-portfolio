...
export const BrandElementsDisplay: FC<TypeBrandElementsDisplay> = ({
  fields,
}) => {
  ...
  return (
    <SlideFrame>
      <ContentWrapper>
        ...
        <IconList>
          <LogoImage
            src={"https:" + fields.leftLogo.fields.file.url}
            alt={fields.leftLogo.fields.description}
          />
          <LilIconList>
            {icons &&
              icons.map((icon, index) => (
                <IconImg
                  key={index + "_" + icon.sys.id}
